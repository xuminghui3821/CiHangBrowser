...
public class WhiteListAdapter extends RecyclerView.Adapter<WhiteListAdapter.WhiteListHolder> {
    ...
    public List<UserWhiteUrl> entities;
    ...
    public WhiteListAdapter(Context Context, List<UserWhiteUrl> whiteList1) {
    ...
    public void chageView(List<UserWhiteUrl> bookmarkEntities, boolean ischeck) {
    ...
    public WhiteListHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new WhiteListHolder(view);
    }

    @Override
    public void onBindViewHolder(final WhiteListHolder holder, final int position) {
        final UserWhiteUrl item = entities.get(position);
        if (checkMode) {
                ...
                view.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (Patterns.WEB_URL.matcher(newurl).matches()) {
                            ...
                            item.setUrl(newurl);
                            userWhiteUrlDao.update(item);
                            entities = userWhiteUrlDao.queryBuilder().orderAsc(UserWhiteUrlDao.Properties.Id).list();//获取最新列表状态
